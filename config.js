...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~f59a241de07322232dd05eb7390ee451:77765278313771576f45633d',
    ...
    BOT_NAME: process.env.BOT_NAME || 'kiki',
    ...
    SUDO: process.env.SUDO || "0721534466",
